...
/* package parse-exposition-0.1.0.0 */
#ifndef VERSION_parse_exposition
#define VERSION_parse_exposition "0.1.0.0"
#endif /* VERSION_parse_exposition */
#ifndef MIN_VERSION_parse_exposition
#define MIN_VERSION_parse_exposition(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_parse_exposition */
...
/* package html-conduit-1.3.2 */
#ifndef VERSION_html_conduit
#define VERSION_html_conduit "1.3.2"
...
#define CURRENT_COMPONENT_ID "parse-exposition-0.1.0.0-6HKtCzaYd4a6s5TFp1N5JR-parse-exposition"
